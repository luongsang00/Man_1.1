...
void CPlayScenceKeyHandler::OnKeyDown(int KeyCode)
{
	...
	case DIK_SPACE:
		...
		break;
	case DIK_F:	
		mario->SetLevel(MARIO_LEVEL_LUA);
		break;
	case DIK_S:
		mario->SetLevel(MARIO_LEVEL_DUOI);
		break;
	case DIK_A:
		mario->Reset();
		break;
...
void CPlayScenceKeyHandler::KeyState(BYTE* states)
{
	...
	else if (game->IsKeyDown(DIK_RIGHT) && game->IsKeyDown(DIK_LSHIFT))
	{
		mario->SetState(MARIO_STATE_RUN_RIGHT);
	}
	else if (game->IsKeyDown(DIK_LEFT) && game->IsKeyDown(DIK_LSHIFT))
	{
